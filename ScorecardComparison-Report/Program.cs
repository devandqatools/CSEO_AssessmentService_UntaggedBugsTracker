...
{
    //Authors : Chidvilash Vakada
    //Date Written : 18th May 2020
    /// <summary>
    /// This is Automatic Email for Untagged MAS bugs.
    /// </summary>
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string Query = string.Format("select RecID,AppName from [{0}] where AppName <> null and RecID <> null group by RecID,AppName", "Sheet1$");
        ...
        /// </summary>
        /// <param name="dataMapWithMails"></param>
        /// <param name="currentAppName"></param>
        /// <param name="recID"></param>
